...
def runClassifier(args, options):
    ...
    if(options.data=="pacman"):
        ...
        # = samples.loadDataFile("digitdata/trainingimages", numTraining,DIGIT_DATUM_WIDTH,DIGIT_DATUM_HEIGHT)
    ...
    trainingData = DataLoad.loadClassifierTrainingData()
    trainingLabels = DataLoad.loadClassifierTrainingLabels()
    validationData = DataLoad.loadClassifierValidationData()
    validationLabels = DataLoad.loadClassifierValidationLabels()
    testData = DataLoad.loadClassifierTestData()
    testLabels = DataLoad.loadClassifierTestLabels()
